...
* Download [this file](../unitc/basic/unitc_basic1.tex) and modify it.
* Here's [the PDF](../unitc/basic/unitc_basic1.pdf) of this file (so you can look at the questions now if you wish).
...
* Download [this file](../unitc/advanced/unitc-advanced.tex) and modify it.
* Here's [the PDF](../unitc/advanced/unitc-advanced.pdf) of this file (so you can look at the questions now if you wish).
...
* Due date: April 15, 11:30pm.  Submit to Gradescope.  **Submissions with test cases will open Fri., April 1.** <b style="color:red">Update: Due Sunday, April 17, 11:30pm.  Late submissions with 10pt penalty by Tuesday, April 19, 11:30pm</b>
    * **Note:** Gradescope will only run tests for and grade your first **20** submissions.  It's important to plan your algorithm before coding and write your own test cases.
